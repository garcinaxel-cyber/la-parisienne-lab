...
import { LayoutDashboard, Upload, ClipboardList, Users, LogOut, FlaskConical, BookOpen, Package2 } from 'lucide-react';
...
const ADMIN_NAV = [
  ...
  { href: '/admin/lab-products', icon: Package2,  key: 'labProducts' as const },
];
