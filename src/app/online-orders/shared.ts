...
export const L = {
  vi: {
    ...
    districtPlaceholder: '— Quận/huyện (không bắt buộc) —',
    ...
    pMonth: 'Theo tháng', pDay: 'Theo ngày', pClear: 'Bỏ chọn',
    channelOrdersLoading: 'Đang tải danh sách đơn...',
    channelOrdersEmpty: 'Không có đơn nào trong kỳ này.',
    ...
    custLastDistrict: 'Quận/huyện gần nhất',
    custDistrictFilterAll: 'Tất cả quận/huyện',
    ...
    refundPrompt: 'Số tiền hoàn (₫). Bằng tổng đơn = huỷ toàn bộ đơn. Ít hơn = đơn vẫn tính bình thường, chỉ trừ số tiền này. Không ảnh hưởng Odoo.',
    refundedBadge: '↩ Đã hoàn tiền',
    refundedPartialBadge: '↩ Hoàn 1 phần',
    refundedAmountLabel: 'Đã hoàn',
    refundedByShort: 'bởi ',
    adjustRefundBtn: 'Sửa',
  ...
  en: {
    ...
    pMonth: 'By month', pDay: 'By day', pClear: 'Clear',
    channelOrdersLoading: 'Loading orders...',
    channelOrdersEmpty: 'No orders in this period.',
    ...
    custLastDistrict: 'Last known district',
    custDistrictFilterAll: 'All districts',
    ...
    refundPrompt: "Refund amount. Equal to the order total = the whole order is cancelled. Less = the order stays active, just minus this amount. No impact on Odoo.",
    refundedBadge: '↩ Refunded',
    refundedPartialBadge: '↩ Partially refunded',
